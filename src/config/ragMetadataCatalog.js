...
const RAG_EXCEL_COLUMN_MAPPINGS = [
  {
    ...
    mappings: [
      ...
      { excelColumn: 'DOC_TURNO', aliases: ['turno'], targetModel: 'TeacherImport', targetTable: 'docentes', targetColumn: 'turno', meaning: 'Turno del docente. Matutino, vespertino o X para turno Mixto' },
      ...
      { excelColumn: 'DICTAMEN', aliases: ['dictamen'], targetModel: 'TeacherImport', targetTable: 'docentes', targetColumn: 'dictamen', meaning: 'Categoria dictaminada del docente. La descripcion de la categoria se encuentra en la columna CATEGORIA de la tabla CATALOGO_CATEGORIAS.' },
      { excelColumn: 'PLAZA', aliases: ['clavePlaza', 'clave'], targetModel: 'PositionImport', targetTable: 'Plazas', targetColumn: 'clave', meaning: 'Clave de categoria de la plaza asignada. La descripcion de la categoria se encuentra en la columna CATEGORIA de la tabla CATALOGO_CATEGORIAS.' },
      ...
      { excelColumn: 'S', aliases: ['STATUS', 'status'], targetModel: 'PositionImport', targetTable: 'Plazas', targetColumn: 'status', meaning: 'Estatus de la plaza.  A significa activa, L significa en licencia y B significa en Baja.' },
      ...
      { excelColumn: 'FUNCIONES', aliases: ['funciones'], targetModel: 'PositionImport', targetTable: 'docentes', targetColumn: 'funciones', meaning: 'Funciones del docente, actividades fuera del salón de clases' },
    ],
  },
  {
    source: 'MXG',
